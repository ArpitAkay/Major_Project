...
class Student:
    def __init__(self,root):
        ...
        title_lbl=Label(bgimage,text="STUDENT MANAGEMENT SYSTEM",font=("Book Antiqua",25,"bold"),bg="white",fg="blue")
        ...
        #LeftImage
        imgleft=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FaceRecognitionSystem\images\GEU2008.jpg") 
        imgleft=imgleft.resize((745,130),Image.ANTIALIAS)
        ...
        currentcourseframe.place(x=15,y=170,width=745,height=150)
        ...
        studentinfoframe.place(x=15,y=320,width=745,height=270)
        ...
        rno_entry.grid(row=1,column=3,padx=10,pady=5,sticky=W)
        ...
        pno_label.grid(row=3,column=2,padx=10,pady=5,sticky=W)

        pno_entry=ttk.Entry(studentinfoframe,textvariable=self.v_phone,width=20,font=("Book Antiqua",12,"bold"))
        pno_entry.grid(row=3,column=3,padx=10,pady=5,sticky=W)
        ...
        cc_entry.grid(row=4,column=3,padx=10,pady=5,sticky=W)
        ...
        #ButtonFrameInStudentInfoFrame
        btn_frame=Frame(studentinfoframe,bd=2,relief=RIDGE,bg="white")
        btn_frame.place(x=0,y=205,width=740,height=40)

        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=11,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",width=11,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",width=11,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        delete_btn.grid(row=0,column=2)

        reset_btn=Button(btn_frame,text="Reset",width=11,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        reset_btn.grid(row=0,column=3)

        takephoto_btn=Button(btn_frame,text="Take Photo",width=11,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        takephoto_btn.grid(row=0,column=4)

        updatephotosample_btn=Button(btn_frame,text="Update Photo",width=13,font=("Book Antiqua",12,"bold"),bg="blue",fg="white")
        ...
        imgright=Image.open(r"C:\Users\DELL\OneDrive\Desktop\FaceRecognitionSystem\images\GEU2008.jpg") 
        imgright=imgright.resize((745,130),Image.ANTIALIAS)
        self.photoimgright=ImageTk.PhotoImage(imgleft)
        ...
        searchframe.place(x=786,y=170,width=685,height=70)
        ...
        tableframe.place(x=5,y=210,width=684,height=350)
